...
porcentagem = (total * 100.0) / numeroeleitores

print("Total de votos esperados: {}, foram votados {}%".format(totalEleitores, porcentagem))

#print("O total de votos é: {} {}", totalEleitores, porcentagem)
